...
<html lang="en">
      ...
      <section class="inicio-banner">
        <div class="banner-contenido">
          ...
          <div class="banner-fecha-hora">
            <span class="fecha" id="fecha-banner"></span>
            <span class="hora" id="hora-banner"></span>
          </div>
        </div>
      </section>

      <!-- Botones en la seccion Inicio -->
      <section class="cajas-secciones">
        <a href="#">
          <div class="caja-seccion-inicio">
            <!-- Icono  -->
            <div class="caja-inicio-icono">
              <i class='bx bx-calendar icon-home'></i>
            </div>
            <!-- Nombre de la seccion  -->
            <div class="caja-inicio-texto"><h1>Calendario</h1></div>
          </div></a
        >
        ...
        <a href="{{ route('recipe.index') }}"
          ><div class="caja-seccion-inicio">
            <!-- Icono  -->
            <div class="caja-inicio-icono">
              <i class='bx bx-receipt icon-home'></i>
            </div>
            <!-- Nombre de la seccion  -->
            <div class="caja-inicio-texto"><h1>Recetas</h1></div>
          </div></a
        >
        <a href=""
          ><div class="caja-seccion-inicio">
            <!-- Icono  -->
            <div class="caja-inicio-icono">
              <i class='bx bx-package icon-home'></i>
            </div>
            <!-- Nombre de la seccion  -->
        ...
        <a href="{{ route('postres.index') }}">
          <div class="caja-seccion-inicio">
            ...
            <!-- Nombre de la seccion  -->
            <div class="caja-inicio-texto"><h1>Postres</h1></div>
          </div></a
        >
      </section>
    </div>
  ...
  <script>
      ...
      const horaElemento = document.getElementById("hora-banner");
      ...
      fechaElemento.textContent = ahora.toLocaleDateString("en-US", opcionesFecha);
      horaElemento.textContent = ahora.toLocaleTimeString("en-US", opcionesHora);
    }

    actualizarFechaHora(); // Ejecutar al cargar
